...
# =========================================
# 색상별 HSV 범위 (수정본 - 오인식 감소)
# =========================================
COLOR_CFG = {
    "red": {
        # 빨강: 110 60 220 / 170 190 225 부근 반영
        "hsv1": ([0, 110, 110], [10, 190, 255]),
        "hsv2": ([170, 110, 110], [179, 190, 255]),
        "bgr":  ([20, 20, 80], [180, 180, 255]),
        "draw": (0, 0, 255),
    },
    ...
    "blue": {
        # 파랑: 160 110 90 / 110 100 160 부근
        "hsv1": ([100, 90, 70], [130, 255, 200]),
        "hsv2": None,
        "bgr":  ([60, 0, 0], [255, 180, 180]),
        "draw": (255, 80, 0),
    },
}
